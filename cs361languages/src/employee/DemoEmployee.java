...
//		PartTimeEmployee pEmp2 = new PartTimeEmployee("Melissa", "Will", "123456666", 23.5);
		...
		emp3.whoAmI();
		// TODO To complete
		// emp3.whoAmI() // prints I am an Employee because the method from the Employee class is being used
		// emp3.getHourlyRate(); // returns syntax error because ... the method is not defined in the Employee class
